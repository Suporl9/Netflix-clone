...
function AuthProvider({children}) {
  ...
  return <AuthContext.Provider value={value}>{!loading && children}</AuthContext.Provider>;   //pass these props data to the child components if only there is a user or dont(we no longer have any currentuser)
}
